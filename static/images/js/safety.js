             ...
             success: function(response) {
              ...
              if (pages != null){
                  ...
                  for (let i = 0; i < response["results"].length; i++) {
                    ...
                    var img_url = results["image"]
                    let main = document.createElement("div")
                    main.classList.add("max-w-sm" ,"rounded" ,"overflow-hidden" ,"shadow-lg" ,"hover:bg-gray-200")
                    
                    var part1 = "https://d3pvj3ro00vroz.cloudfront.net";
                    img_url= part1 + img_url.slice(21);
                  ...
                  pagesContainer.appendChild(ul);
                      ...
                      if (results.length > 1){
                        for (let i = 0; i < response.length-1; i++){
                          var img_url = results["image"]
                          let main = document.createElement("div")
                          main.classList.add("rounded" ,"overflow-hidden" ,"shadow-lg" ,"hover:bg-gray-200")
                          var part1 = "https://d3pvj3ro00vroz.cloudfront.net";
                          img_url= part1 + img_url.slice(21);
